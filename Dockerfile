...
LABEL org.opencontainers.image.title="semrel-plugin-updater-pubspec" \
      org.opencontainers.image.description="semrel plugin: updater-pubspec" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/updater-pubspec" \
